...
<head>
  ...
  <title>Dashboard MallSampah</title>
  <link rel="icon" href="{{ asset('images/login/faviconMS.png') }}">
  ...
  <link rel="stylesheet" href="{{ asset('css/login/auth.css.map') }}">
</head>
<body>
    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="{{ asset('images/login/mallsampahlgimg1.png') }}" alt="login-card-img" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
